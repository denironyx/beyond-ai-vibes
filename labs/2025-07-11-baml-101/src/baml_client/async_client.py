...
class BamlAsyncClient:
    ...
    async def ClassifyText(self, input: str,
        baml_options: BamlCallOptions = {},
    ) -> types.SpamType:
        result = await self.__options.merge_options(baml_options).call_function_async(function_name="ClassifyText", args={
            "input": input,
        })
...
class BamlStreamClient:
    ...
    def ClassifyText(self, input: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[types.SpamType, types.SpamType]:
        ctx, result = self.__options.merge_options(baml_options).create_async_stream(function_name="ClassifyText", args={
            "input": input,
        })
        return baml_py.BamlStream[types.SpamType, types.SpamType](
          result,
    ...
    def ClassifyTicket(self, ticket: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[typing.List[types.TicketLabel], typing.List[types.TicketLabel]]:
        ctx, result = self.__options.merge_options(baml_options).create_async_stream(function_name="ClassifyTicket", args={
            "ticket": ticket,
        })
        return baml_py.BamlStream[typing.List[types.TicketLabel], typing.List[types.TicketLabel]](
          result,
...
class BamlHttpRequestClient:
    ...
    async def ClassifyText(self, input: str,
        ...
        result = await self.__options.merge_options(baml_options).create_http_request_async(function_name="ClassifyText", args={
            "input": input,
        }, mode="request")
        return result
    async def ClassifyTicket(self, ticket: str,
